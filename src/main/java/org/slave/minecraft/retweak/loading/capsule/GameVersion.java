...
public enum GameVersion {
    ...
    GameVersion(final String version, final String[] classes, final boolean hasResources, final Bulk<Type, String> modType) {
        this.version = version;
        this.mcClasses = Collections.unmodifiableList(
                Arrays.asList(
                        classes
                )
        );
        //noinspection StringBufferReplaceableByString
        this.interpreterPackagePrefix = new StringBuilder(
