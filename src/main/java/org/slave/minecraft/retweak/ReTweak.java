...
public final class ReTweak {
    ...
    public static final File FILE_DIRECTORY_RETWEAK_ASM_DEOBFUSCATED = new File(ReTweak.FILE_DIRECTORY_RETWEAK_ASM, "deobfuscated");
    ...
    public static final boolean DEBUG = Boolean.parseBoolean(System.getProperty("org.slave.minecraft.retweak.debug", Boolean.FALSE.toString()));
